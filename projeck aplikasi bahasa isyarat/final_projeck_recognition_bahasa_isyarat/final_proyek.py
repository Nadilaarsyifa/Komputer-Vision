...
# Model angka sekarang memakai video sequence / BiLSTM
...
# ==========================================================
# KONFIGURASI KHUSUS MODE KATA VIDEO
# ==========================================================
SEQUENCE_LENGTH_KATA = 30
FEATURE_SIZE_KATA    = 162
PREDICT_EVERY_KATA   = 5
NO_HAND_LIMIT_KATA   = 10
CONF_THRESHOLD_KATA  = 0.70

sequence_kata        = deque(maxlen=SEQUENCE_LENGTH_KATA)
pred_buffer_kata     = deque(maxlen=10)
final_pred_kata      = "-"
final_conf_kata      = 0.0
...
# ==========================================================
# FUNGSI EKSTRAK ANGKA VIDEO — 1 TANGAN, 63 FITUR
# ==========================================================
    ...
    if mode == "huruf":
        ...
        if result.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(
                ...
                # Tampilkan landmark tangan agar tampilan konsisten dengan mode angka
        ...
        if result.multi_hand_landmarks:
            ...
            pred = "-"
    # ======================================================
    # MODE ANGKA — VIDEO SEQUENCE / BiLSTM
    # ======================================================
    elif mode == "angka":
        result = hands.process(rgb)
        hand_detected = False
